...
(library Library_1
	...
	(patternDef "PCM12SMTR" (originalName "PCM12SMTR")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.850) (textStyleRef "Normal") (isVisible True))
		)
	...
	(compDef "PCM12SMTR" (originalName "PCM12SMTR") (compHeader (numPins 7) (numParts 1) (refDesPrefix S)
		...
		(attr "<Hyperlink>" "https://www.ckswitches.com/media/1424/pcm.pdf")
		(attr "<Component Height>" "1.4")
		(attr "<STEP Filename>" "PCM12SMTR.stp")
		(attr "<STEP Offsets>" "X=0;Y=-0.04;Z=0.71")
